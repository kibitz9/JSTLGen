...
public class SDFOperationTrigRotateX extends SDFOperationTrigRotate {
    ...
    public SDFOperationTrigRotateX(SignedDistanceField3d toRotate, String rotationExpression)
    {
    ...
    public ShaderString toShaderString(String parm){
        ...
        functions +="\r\n\tvec3 p=vec3(q.x,q.y*"+cosThetaVar+"+q.z*"+sinThetaVar+",q.z*"+cosThetaVar+"+q.y*-"+sinThetaVar+");"; 
        functions +="\r\n\treturn "+c.color+";";
        functions +="\r\n}";
        color = fn+"(p)"; 
